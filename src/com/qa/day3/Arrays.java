...
public class Arrays {
	...
	public static void array() {
		...
		//Extension: 
		//create a Print function to print out all the values in your multi-dimensional array
	...
	public static void arrayList() {
		...
		Integer b = 3; // non-primitive version of an integer, belongs to a class so can call methods on it
